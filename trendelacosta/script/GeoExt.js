...
GeoExt.plugins.AttributeForm.prototype = {
    ...
    init: function (a) {
        this.formPanel = a;
        this.attributeStore instanceof Ext.data.Store && (this.fillForm(), this.bind(this.attributeStore));
    ...
    onLoad: function () {
        this.formPanel.items && this.formPanel.removeAll();
        this.fillForm()
    },
    fillForm: function () {
        this.attributeStore.each(function (a) {
            (a = GeoExt.form.recordToField(a, Ext.apply({
                checkboxLabelProperty: "fieldLabel"
            }, this.recordToFieldOptions || {}))) && this.formPanel.add(a)
        }, this);
...
GeoExt.plugins.PrintProviderField = Ext.extend(Ext.util.Observable, {
    ...
    onRender: function (a) {
        ...
        a.store === b.layouts ? (a.setValue(b.layout.get(a.displayField)),
            b.on({
    ...
    onRenderNode: function (a) {
        ...
        if (!a.rendered && b) {
            ...
            "function" == typeof b ? b = b(a,
                c) : "object" == typeof b && "function" == typeof b.fn && (b = b.fn.apply(b.scope, [a, c]));
            "object" == typeof b && "string" == typeof b.xtype && (b = Ext.ComponentMgr.create(b));
            if (b instanceof Ext.Component) b.render(c), a.component = b
        }
    },
...
GeoExt.plugins.TreeNodeRadioButton = Ext.extend(Ext.util.Observable, {
    ...
    onRenderNode: function (a) {
        var b = a.attributes;
        if (b.radioGroup && !b.radio) b.radio =
            Ext.DomHelper.insertBefore(a.ui.anchor, ['<input type="radio" class="gx-tree-radio" name="', b.radioGroup, '_radio"></input>'].join(""))
    },
    onRawClickNode: function (a, b) {
        var c = b.getTarget(".gx-tree-radio", 1);
        if (c) return c.defaultChecked = c.checked, this.fireEvent("radiochange", a), !1
    },
    onDisabledChange: function (a, b) {
        var c = a.attributes.radio;
        if (c) c.disabled = b
    },
    onBeforeDestroy: function (a) {
        a.un("rendernode", this.onRenderNode, this);
        a.un("rawclicknode", this.onRawClickNode, this);
        a.un("beforedestroy", this.onBeforeDestroy,
            this)
    }
});
...
GeoExt.plugins.TreeNodeActions = Ext.extend(Ext.util.Observable, {
    ...
    onRenderNode: function (a) {
        if (!a.rendered) {
            var b =
                a.attributes.actions || this.actions;
            if (b && 0 < b.length) {
                for (var c = ['<div class="', this.actionsCls, '">'], d = 0, e = b.length; d < e; d++) var f = b[d],
                    c = c.concat(['<img id="' + a.id + "_" + f.action, '" ext:qtip="' + f.qtip, '" src="' + Ext.BLANK_IMAGE_URL, '" class="' + this.actionCls + " " + f.action + '" />']);
                c.concat(["</div>"]);
                Ext.DomHelper.insertFirst(a.ui.elNode, c.join(""))
            }
            if (a.layer && a.layer.map) this.updateActions(a);
            else if (a.layerStore) a.layerStore.on({
                bind: function () {
    ...
    updateActions: function (a) {
        Ext.each(a.attributes.actions ||
            this.actions || [], function (b) {
                var c = Ext.get(a.id + "_" + b.action);
                c && "function" == typeof b.update && b.update.call(a, c)
            })
    },
    onRawClickNode: function (a, b) {
        if (b.getTarget("." + this.actionCls, 1)) {
            var c = b.getTarget("." + this.actionCls, 1).className.replace(this.actionCls + " ", "");
            this.fireEvent("action", a, c, b);
            return !1
        }
    },
    onBeforeDestroy: function (a) {
...
GeoExt.plugins.PrintExtent = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function (a) {
        ...
        Ext.apply(this, a);
        this.initialConfig = a;
        if (!this.printProvider) this.printProvider = this.pages[0].printProvider;
    ...
    init: function (a) {
        ...
        if (!this.layer) this.layer = new OpenLayers.Layer.Vector(null, {
            displayInLayerSwitcher: !1
        });
        this.createControl();
        for (var a = 0, b = this.pages.length; a < b; ++a) this.addPage(this.pages[a]);
        this.show()
    },
    addPage: function (a) {
        a = a || new GeoExt.data.PrintPage({
            printProvider: this.printProvider
        }); - 1 === this.pages.indexOf(a) && this.pages.push(a);
    ...
    show: function () {
        ...
        this.page &&
            this.map.getCenter() && this.updateBox()
    },
    hide: function () {
        var a = this.map,
            b = this.layer,
                ...
                beforetransform: function (a) {
                    ...
                    if (a.rotation) this.printProvider.layout.get("rotation") ? b.setRotation(-a.object.rotation) : a.object.setFeature(b.feature);
                        ...
                        var c = this.printProvider.scales.getAt(0),
                            ...
                            e = b.feature.geometry.getBounds(),
                            c = b.scale === c && a.containsBounds(e),
                            b = b.scale === d &&
                            e.containsBounds(a);
...
GeoExt.data.PrintPage = Ext.extend(Ext.util.Observable, {
    ...
    fit: function (a, b) {
        ...
        else if (a instanceof OpenLayers.Feature.Vector) c = a.layer.map, d = a.geometry.getBounds();
        ...
        this.printProvider.scales.each(function (a) {
            ...
            if ("closest" == b.mode) c = Math.abs(c.getWidth() - i) + Math.abs(c.getHeight() - j), c < h &&
                (h = c, g = a);
            else {
    ...
    calculatePageBounds: function (a,
        b) {
        var c = a.get("value"),
            d = this.feature,
...
Ext.extend(GeoExt.data.AttributeReader, Ext.data.DataReader, {
    ...
    readRecords: function (a) {
        for (var a = a instanceof Array ? a : this.meta.format.read(a).featureTypes[0].properties, b = this.meta.feature, c = this.recordType, d = c.prototype.fields, e = d.length, f, g, h, i, j, k = [], l = 0, m = a.length; l < m; ++l) {
            ...
            if (b) j = b.attributes[g.name], void 0 !== j && (this.ignoreAttribute("value", j) ? i = !0 : g.value = j);
...
GeoExt.data.WFSCapabilitiesStore = function (a) {
    ...
    GeoExt.data.WFSCapabilitiesStore.superclass.constructor.call(this, Ext.apply(a, {
        ...
        reader: new GeoExt.data.WFSCapabilitiesReader(a, a.fields)
    }))
};
...
GeoExt.data.ScaleStore = Ext.extend(Ext.data.Store, {
    ...
    bind: function (a) {
        ...
        this.map.baseLayer ? this.populateFromMap() : this.map.events.register("addlayer",
            this, this.populateOnAdd)
    },
    unbind: function () {
...
Ext.extend(GeoExt.data.WMSCapabilitiesReader, Ext.data.DataReader, {
    ...
    imageFormat: function (a) {
        var b = a.formats;
        return a.opaque && -1 < OpenLayers.Util.indexOf(b,
            "image/jpeg") ? "image/jpeg" : -1 < OpenLayers.Util.indexOf(b, "image/png") ? "image/png" : -1 < OpenLayers.Util.indexOf(b, "image/png; mode=24bit") ? "image/png; mode=24bit" : -1 < OpenLayers.Util.indexOf(b, "image/gif") ? "image/gif" : b[0]
    },
    ...
    readRecords: function (a) {
        ...
        var b = a.version,
            c = a.capability || {},
            a = c.request && c.request.getmap &&
            c.request.getmap.href,
            d = c.layers,
            c = this.serviceExceptionFormat(c.exception ? c.exception.formats : []),
            e = [];
        if (a && d)
            for (var f = this.recordType.prototype.fields, g, h, i, j, k = 0, l = d.length; k < l; k++)
                if (g = d[k], g.name) {
                    h = {};
                    for (var m = 0, n = f.length; m < n; m++) i = f.items[m], j = g[i.mapping || i.name] || i.defaultValue, j = i.convert(j), h[i.name] = j;
                    i = {
    ...
    attributionMarkup: function (a) {
        ...
        if (a.href)
            for (var c = 0; c < b.length; c++) b[c] = "<a class='" + this.attributionCls + "-link' href=" + a.href + ">" + b[c] + "</a>";
        return b.join(" ")
    }
});
Ext.namespace("GeoExt.data");
...
GeoExt.data.FeatureRecord.create = function (a) {
    var b = Ext.extend(GeoExt.data.FeatureRecord, {}),
        c = b.prototype;
    c.fields = new Ext.util.MixedCollection(!1, function (a) {
        return a.name
    });
    ...
    if (a)
        for (var d = 0, e = a.length; d < e; d++) c.fields.add(new Ext.data.Field(a[d]));
...
Ext.extend(GeoExt.data.ProtocolProxy, Ext.data.DataProxy, {
    ...
    load: function (a, b, c, d, e) {
        !1 !== this.fireEvent("beforeload", this, a) ? (b = OpenLayers.Function.bind(this.loadResponse, this, {
            params: a || {},
            request: {
                callback: c,
                scope: d,
            ...
            callback: b,
            scope: this
        }, Ext.applyIf(a, e), !0 === this.setParamsAsOptions && (Ext.applyIf(a, a.params), delete a.params), this.response = this.protocol.read(a)) :
            c.call(d || this, null, e, !1)
    },
    abortRequest: function () {
        if (this.response) this.protocol.abort(this.response), this.response = null
    },
    loadResponse: function (a, b) {
        ...
        } else this.fireEvent("loadexception", this, a, b), a.request.callback.call(a.request.scope, null, a.request.arg, !1)
    }
});
Ext.namespace("GeoExt.data");
    ...
    encodeLayer: function (a) {
        ...
        for (c in this.encoders.layers)
            if (OpenLayers.Layer[c] && a instanceof OpenLayers.Layer[c]) {
                if (!1 === this.fireEvent("beforeencodelayer",
                    this, a)) return;
    ...
    encoders: {
        layers: {
            ...
            WMS: function (a) {
                ...
                var c, d;
                for (d in a.params)
                    if (c = d.toLowerCase(), !a.DEFAULT_PARAMS[c] && -1 == "layers,styles,width,height,srs".indexOf(c)) {
            ...
            OSM: function (a) {
                a = this.encoders.layers.TileCache.call(this,
                    a);
                return Ext.apply(a, {
                    type: "OSM",
            ...
            WMTS: function (a) {
                var b =
                    this.encoders.layers.HTTPRequest.call(this, a);
                return Ext.apply(b, {
                    type: "WMTS",
                    layer: a.layer,
                    version: a.version,
            ...
            KaMapCache: function (a) {
                var b =
                    this.encoders.layers.KaMap.call(this, a);
                return Ext.apply(b, {
                    type: "KaMapCache",
                    group: a.params.g,
            ...
            HTTPRequest: function (a) {
                var b = this.encoders.layers.Layer.call(this,
                    a);
                return Ext.apply(b, {
            ...
            Vector: function (a) {
                if (a.features.length) {
                    for (var b = [], c = {}, d = a.features, e = new OpenLayers.Format.GeoJSON,
                        f = new OpenLayers.Format.JSON, g = 1, h = {}, i, j, k, l, m = 0, n = d.length; m < n; ++m) i = d[m], j = i.style || a.style || a.styleMap.createSymbolizer(i, i.renderIntent), k = f.write(j), (l = h[k]) ? k = l : (h[k] = k = g++, c[k] = j.externalGraphic ? Ext.applyIf({
                        externalGraphic: this.getAbsoluteUrl(j.externalGraphic)
                    }, j) : j), i = e.extract.feature.call(e, i), i.properties = OpenLayers.Util.extend({
                        _gx_style: k
                    }, i.properties), b.push(i);
...
GeoExt.data.FeatureStoreMixin = function () {
    return {
        ...
        constructor: function (a) {
            a = a || {};
            a.reader = a.reader || new GeoExt.data.FeatureReader({}, a.fields);
            var b = a.layer;
            delete a.layer;
        ...
        bind: function (a, b) {
            if (!this.layer) {
                ...
                var b = b || {},
                    c = b.initDir;
                void 0 == b.initDir && (c = GeoExt.data.FeatureStore.LAYER_TO_STORE |
                    GeoExt.data.FeatureStore.STORE_TO_LAYER);
                var d = a.features.slice(0);
                if (c & GeoExt.data.FeatureStore.STORE_TO_LAYER)
                    for (var e = this.getRange(), f = e.length - 1; 0 <= f; f--) this.layer.addFeatures([e[f].getFeature()]);
        ...
        unbind: function () {
            if (this.layer) this.layer.events.un({
                ...
                featuremodified: this.onFeatureModified,
                scope: this
            }), this.un("load", this.onLoad, this), this.un("clear", this.onClear, this), this.un("add", this.onAdd, this), this.un("remove", this.onRemove, this), this.un("update", this.onUpdate, this), this.layer = null
        },
        ...
        getByFeature: function (a) {
            var b;
            if (a.state !== OpenLayers.State.INSERT) b =
                this.getById(a.id);
            else {
            ...
            if (!this._adding) {
                ...
                if (this.featureFilter) {
                    var b = [],
                        c, d, e;
                    c = 0;
                    for (d = a.length; c < d; c++) e = a[c], !1 !== this.featureFilter.evaluate(e) && b.push(e)
                }
                this._adding = !0;
                this.loadData(b, !0);
                delete this._adding
        ...
        onFeaturesRemoved: function (a) {
            if (!this._removing) {
                ...
                for (c = a.length - 1; 0 <= c; c--)
                    if (b = a[c], b = this.getByFeature(b), void 0 !== b) this._removing = !0, this.remove(b), delete this._removing
            }
        },
        onFeatureModified: function (a) {
            if (!this._updating) {
                ...
                if (void 0 !== b) {
                    ...
                    var c = a.attributes;
                    if (c)
                        for (var d = this.recordType.prototype.fields, e = 0, f = d.length; e < f; e++) {
                            var g = d.items[e],
                                h = g.mapping || g.name;
        ...
        addFeaturesToLayer: function (a) {
            ...
            d = Array(c = a.length);
            for (b =
                0; b < c; b++) d[b] = a[b].getFeature();
            if (0 < d.length) this._adding = !0, this.layer.addFeatures(d), delete this._adding
        },
        onLoad: function (a, b, c) {
            if (!c || !0 !== c.add) this._removing = !0, this.layer.removeFeatures(this.layer.features), delete this._removing, this.addFeaturesToLayer(b)
        },
        onClear: function () {
            this._removing = !0;
        ...
        onRemove: function (a, b) {
            if (!this._removing && null != this.layer.getFeatureById(b.getFeature().id)) this._removing = !0, this.layer.removeFeatures([b.getFeature()]), delete this._removing
        },
...
GeoExt.data.WMCReader = function (a, b) {
    a = a || {};
    if (!a.format) a.format = new OpenLayers.Format.WMC;
    "function" !== typeof b && (b = GeoExt.data.LayerRecord.create(b || a.fields || [{
        name: "abstract",
        type: "string"
    }, {
...
Ext.extend(GeoExt.data.WMCReader, Ext.data.DataReader, {
    ...
    readRecords: function (a) {
        var b = this.meta.format;
        if ("string" === typeof a || a.nodeType) a = b.read(a);
        var a = a ? a.layersContext : void 0,
            c = [];
        if (a) {
            ...
            for (e = 0, f = a.length; e < f; e++) {
                i = a[e];
                j = {};
                for (g = 0, h = d.length; g < h; g++) k = d.items[g], l = i[k.mapping || k.name] || k.defaultValue, l = k.convert(l), j[k.name] = l;
                j.layer =
                    b.getLayerFromContext(i);
                c.push(new this.recordType(j, j.layer.id))
            }
        }
        return {
            totalRecords: c.length,
            success: !0,
            records: c
        }
    }
...
GeoExt.data.StyleReader = Ext.extend(Ext.data.JsonReader, {
    ...
    readRecords: function (a) {
        var b;
        b = a instanceof OpenLayers.Symbolizer.Raster ? "colorMap" : "rules";
        this.raw = a;
        Ext.applyIf(this.meta, GeoExt.data.StyleReader.metaData[b]);
        var c = {
            metaData: this.meta
        };
        c[b] = a[b];
        return GeoExt.data.StyleReader.superclass.readRecords.call(this, c)
    }
});
GeoExt.data.StyleReader.metaData = {
    colorMap: {
        ...
        storeToData: function (a) {
            ...
            var b = [];
            a.each(function (a) {
                var d = a.get("symbolizers"),
                    e = a.get("label"),
                    f = a.isModified("label"),
                    g = Number(a.get("filter"));
                a.data.filter = g;
                if (!a.json.label &&
                    !f && a.isModified("filter") || f && !e) a.data.label = g;
                b.push(Ext.apply(a.json, {
                    color: d.fillColor,
    ...
    rules: {
        ...
        storeToData: function (a) {
            ...
            a.each(function (a) {
                var d = a.get("filter");
                "string" === typeof d && (d = d ? OpenLayers.Format.CQL.prototype.read(d) : null);
                b.push(Ext.apply(a.json, {
                    symbolizers: a.get("symbolizers"),
                    filter: d,
                    title: a.get("label"),
                    name: a.get("name"),
                    description: a.get("description"),
                    elseFilter: a.get("elseFilter"),
                    minScaleDenominator: a.get("minScaleDenominator"),
                    maxScaleDenominator: a.get("maxScaleDenominator")
                }))
            });
            return b
        }
...
GeoExt.data.LayerStoreMixin = function () {
    return {
        ...
        constructor: function (a) {
            a = a || {};
            a.reader = a.reader || new GeoExt.data.LayerReader({}, a.fields);
            delete a.fields;
            var b = a.map instanceof GeoExt.MapPanel ? a.map.map : a.map;
            delete a.map;
        ...
        bind: function (a, b) {
            if (!this.map) {
                ...
                var b = b || {},
                    c = b.initDir;
                void 0 ==
                    b.initDir && (c = GeoExt.data.LayerStore.MAP_TO_STORE | GeoExt.data.LayerStore.STORE_TO_MAP);
        ...
        unbind: function () {
            if (this.map) this.map.events.un({
                ...
                removelayer: this.onRemoveLayer,
                scope: this
            }), this.un("load", this.onLoad, this), this.un("clear", this.onClear, this), this.un("add", this.onAdd, this), this.un("remove", this.onRemove, this), this.data.un("replace", this.onReplace, this), this.map = null
        },
        onChangeLayer: function (a) {
            ...
            if (-1 < c) {
                var d = this.getAt(c);
                if ("order" === a.property) {
                    if (!this._adding && !this._removing && (a = this.map.getLayerIndex(b), a !== c)) this._removing = !0, this.remove(d), delete this._removing, this._adding = !0, this.insert(a, [d]), delete this._adding
                } else "name" === a.property ? d.set("title", b.name) : this.fireEvent("update", this, d, Ext.data.Record.EDIT)
            }
        },
        onAddLayer: function (a) {
            if (!this._adding) a = a.layer, this._adding = !0, this.loadData([a], !0), delete this._adding
        },
        onRemoveLayer: function (a) {
            if (this.map.unloadDestroy) {
                if (!this._removing) a = a.layer, this._removing = !0, this.remove(this.getById(a.id)), delete this._removing
            } else this.unbind()
        },
        onLoad: function (a, b, c) {
            Ext.isArray(b) || (b = [b]);
        ...
        onRemove: function (a, b) {
            if (!this._removing && null != this.map.getLayer(b.getLayer().id)) this._removing = !0, this.removeMapLayer(b), delete this._removing
        },
        onUpdate: function (a, b, c) {
            c === Ext.data.Record.EDIT && b.modified && b.modified.title && (a = b.getLayer(), b = b.get("title"), b !== a.name &&
                a.setName(b))
        },
...
GeoExt.data.WFSCapabilitiesReader = function (a, b) {
    a = a || {};
    if (!a.format) a.format = new OpenLayers.Format.WFSCapabilities;
    "function" !== typeof b && (b = GeoExt.data.LayerRecord.create(b || a.fields || [{
        name: "name",
        type: "string"
    }, {
...
Ext.extend(GeoExt.data.WFSCapabilitiesReader, Ext.data.DataReader, {
    ...
    readRecords: function (a) {
        if ("string" === typeof a || a.nodeType) a = this.meta.format.read(a);
        for (var b = a.featureTypeList.featureTypes, c = this.recordType.prototype.fields, d, e, f, g = {
            url: a.capability.request.getfeature.href.post
        }, h = [], i = 0, j = b.length; i < j; i++)
            if (a = b[i], a.name) {
                d = {};
                for (var k = 0, l = c.length; k < l; k++) e = c.items[k], f = a[e.mapping ||
                    e.name] || e.defaultValue, f = e.convert(f), d[e.name] = f;
                e = {
                    featureType: a.name,
                    featureNS: a.featureNS
                };
                this.meta.protocolOptions ? Ext.apply(e, this.meta.protocolOptions, g) : Ext.apply(e, {}, g);
                e = {
                    protocol: new OpenLayers.Protocol.WFS(e),
                    strategies: [new OpenLayers.Strategy.Fixed]
                };
                (f = this.meta.layerOptions) && Ext.apply(e, Ext.isFunction(f) ? f() : f);
                d.layer = new OpenLayers.Layer.Vector(a.title || a.name, e);
                h.push(new this.recordType(d, d.layer.id))
            }
        return {
...
GeoExt.data.AttributeStoreMixin = function () {
    return {
        ...
        onLoad: function (a, b, c) {
            (!c || !0 !== c.add) && this.updateFeature(b)
        },
        onAdd: function (a, b) {
            this.updateFeature(b)
        },
        updateFeature: function (a) {
            var b = this.feature,
                c = b.layer,
                d, e, f, g, h;
            for (d = 0, e = a.length; d < e; d++) f = a[d], g = f.get("name"), f = f.get("value"), g = b.attributes[g], g !== f && (h = !0);
            if (h && c && c.events && !1 !== c.events.triggerEvent("beforefeaturemodified", {
                feature: b
            })) {
                for (d = 0, e = a.length; d < e; d++) f = a[d], g = f.get("name"), f = f.get("value"), b.attributes[g] =
                    f;
            ...
            for (var b in a.data) {
                ...
                if (e instanceof Array)
                    for (var f = 0, g = e.length; f < g; ++f)
                        if (e[f] instanceof Object) e[f] = e[f].value
            }
        });
...
GeoExt.LegendImage = Ext.extend(Ext.BoxComponent, {
    ...
    setUrl: function (a) {
        this.url = a;
        var b = this.getEl();
        if (b) b.un("load", this.onImageLoad, this), b.on("load", this.onImageLoad, this, {
                single: !0
            }),
...
GeoExt.Action = Ext.extend(Ext.Action, {
    ...
    constructor: function (a) {
        ...
        if (b) {
            a.map && (a.map.addControl(b), delete a.map);
            (a.pressed || a.checked) && b.map && b.activate();
            if (b.active) a.pressed = !0, a.checked = !0;
            b.events.on({
    ...
    changeControlState: function (a) {
        if (a) {
            if (!this._activating) this._activating = !0, this.control.activate(), this.initialConfig.pressed = !0, this.initialConfig.checked = !0, this._activating = !1
        } else if (!this._deactivating) this._deactivating = !0, this.control.deactivate(),
...
GeoExt.LayerOpacitySlider = Ext.extend(Ext.slider.SingleSlider, {
    ...
    constructor: function (a) {
        ...
        GeoExt.LayerOpacitySlider.superclass.constructor.call(this,
            a)
    },
    bind: function () {
    ...
    getOpacityValue: function (a) {
        a =
            a && null !== a.opacity ? parseInt(a.opacity * (this.maxValue - this.minValue)) : this.maxValue;
    ...
    initComponent: function () {
        ...
        this.changeVisibility && this.layer && (0 == this.layer.opacity || !1 === this.inverse && this.value == this.minValue || !0 === this.inverse && this.value == this.maxValue) &&
            this.layer.setVisibility(!1);
        ...
        else this.on("changecomplete", this.changeLayerOpacity, this); if (!0 === this.changeVisibility) this.on("change", this.changeLayerVisibility, this, {
            buffer: this.changeVisibilityDelay
        });
        if (this.complementaryLayer) this.on("change",
            this.changeComplementaryLayerVisibility, this, {
                buffer: this.changeVisibilityDelay
            });
        this.on("beforedestroy", this.unbind, this)
    },
    changeLayerOpacity: function (a, b) {
        if (this.layer) b /= this.maxValue - this.minValue, !0 === this.inverse && (b = 1 - b), this._settingOpacity = !0, this.layer.setOpacity(b), delete this._settingOpacity
    },
    changeLayerVisibility: function (a, b) {
        var c = this.layer.getVisibility();
        !1 === this.inverse && b == this.minValue || !0 === this.inverse && b == this.maxValue && !0 === c ? this.layer.setVisibility(!1) : (!1 === this.inverse &&
            b > this.minValue || !0 === this.inverse && b < this.maxValue && !1 == c) && this.layer.setVisibility(!0)
    },
...
GeoExt.Popup = Ext.extend(Ext.Window, {
    ...
    show: function () {
        ...
        this.anchored && (this.position(), this.panIn && !this._mapMove &&
            this.panIntoView())
    },
    maximize: function () {
    ...
    position: function () {
        if (!0 === this._mapMove) this.insideViewport = this.map.getExtent().containsLonLat(this.location), this.insideViewport !== this.isVisible() && this.setVisible(this.insideViewport);
        if (this.isVisible()) {
            ...
            } else this.anc.removeClass("right"), h = this.anc.getLeft(!0), d -= h + f.width / 2; - 1 < g.indexOf("bottom") || a.y > b.height / 2 ? (this.anc.removeClass("top"), c -= e.height + f.height) :
                (this.anc.addClass("top"), c += f.height);
    ...
    panIntoView: function () {
        ...
        b[0] < e.left ? d[0] = e.left : b[0] + c.width > a[0] - e.right &&
            (d[0] = a[0] - e.right - c.width);
        ...
        for (var a, b, c = 0, d = this.slider.thumbs.length; c < d; ++c) a = this.slider.thumbs[c], b = a.tracker.el,
            function (a, b) {
                b.on({
                    ...
                    mouseout: function () {
                        this.dragging || this.hide.apply(this,
                            arguments)
                    },
                    scope: this
                })
...
GeoExt.LayerLegend = Ext.extend(Ext.Container, {
    ...
    initComponent: function () {
        ...
        if (this.layerRecord && this.layerRecord.store) this.layerStore = this.layerRecord.store, this.layerStore.on("update", this.onStoreUpdate, this), this.layerStore.on("add",
            this.onStoreAdd, this), this.layerStore.on("remove", this.onStoreRemove, this)
    },
    getLabel: function () {
...
GeoExt.LayerLegend.getTypes = function (a, b) {
    var c = (b || []).concat(),
        d = [],
        e, f;
    for (f in GeoExt.LayerLegend.types) e = GeoExt.LayerLegend.types[f].supports(a), 0 < e ? -1 == c.indexOf(f) && d.push({
        type: f,
        score: e
    }) : c.remove(f);
    d.sort(function (a, b) {
...
GeoExt.VectorLegend = Ext.extend(GeoExt.LayerLegend, {
    ...
    initComponent: function () {
        ...
        if (this.layerRecord && (this.layer = this.layerRecord.getLayer(), this.layer.map)) this.map = this.layer.map, this.currentScaleDenominator = this.layer.map.getScale(),
    ...
    onFeaturesAdded: function () {
        ...
        this.feature = a;
        this.symbolType =
            this.symbolTypeFromFeature(this.feature);
    ...
    setCurrentScaleDenominator: function (a) {
        if (a !== this.currentScaleDenominator) this.currentScaleDenominator = a, this.update()
    },
    ...
    selectRuleEntry: function (a) {
        ...
        if (b) this.getRuleEntry(a).body.addClass("x-grid3-row-selected"), this.selectedRule = a, this.fireEvent("ruleselected", this, a)
    },
    unselect: function () {
        this.rulesContainer.items.each(function (a, b) {
            if (this.rules[b] ==
                this.selectedRule) a.body.removeClass("x-grid3-row-selected"), this.selectedRule = null, this.fireEvent("ruleunselected", this, this.rules[b])
        }, this)
    },
    ...
    createRuleRenderer: function (a) {
        ...
        if (e) {
            var f, g = 0,
                h = b.length;
            a: for (; g < h; ++g)
                if (c = b[g], f = OpenLayers.Symbolizer[c])
    ...
    update: function () {
        ...
        if (this.symbolType && this.rules) {
            if (this.rulesContainer.items)
                for (var a, b = this.rulesContainer.items.length - 1; 0 <= b; --b) a = this.rulesContainer.getComponent(b), this.rulesContainer.remove(a, !0);
            b = 0;
    ...
    getRuleTitle: function (a) {
        ...
        !b && this.untitledPrefix && (b = this.untitledPrefix + (this.rules.indexOf(a) + 1));
        return b
    },
    beforeDestroy: function () {
...
GeoExt.grid.FeatureSelectionModelMixin = function () {
    return {
        ...
        constructor: function (a) {
            ...
            } else if (a.layer instanceof OpenLayers.Layer.Vector) this.selectControl = this.createSelectControl(a.layer, a.selectControl), delete a.layer,
                delete a.selectControl;
            if (a.autoPanMapOnSelection) this.autoPanMapOnSelection = !0, delete a.autoPanMapOnSelection;
        ...
        initEvents: function () {
            ...
            if (this.layerFromStore) {
                ...
                if (a && !(this.selectControl instanceof OpenLayers.Control.SelectFeature)) this.selectControl = this.createSelectControl(a, this.selectControl)
            }
        ...
        createSelectControl: function (a, b) {
            var b = b || {},
                ...
                c = new OpenLayers.Control.SelectFeature(a, b);
            a.map.addControl(c);
            return c
        },
        bind: function (a, b) {
            if (!this.bound) {
                ...
                if (a instanceof OpenLayers.Layer.Vector) this.selectControl = this.createSelectControl(a, b.controlConfig);
                this.autoActivateControl && this.selectControl.activate();
                for (var c = this.getLayers(),
                    d = 0, e = c.length; d < e; d++) c[d].events.on({
        ...
        unbind: function () {
            ...
            if (this.bound) {
                ...
                this.un("rowselect", this.rowSelected,
                    this);
        ...
        featureSelected: function (a) {
            if (!this._selecting) {
                var b = this.grid.store.findBy(function (b) {
                    return b.getFeature() == a.feature
                });
                if (-1 != b && !this.isSelected(b)) this._selecting = !0, this.selectRow(b, !this.singleSelect), this._selecting = !1, this.grid.getView().focusRow(b)
            }
        },
        featureUnselected: function (a) {
            if (!this._selecting) {
                ...
                if (-1 != b && this.isSelected(b)) this._selecting = !0, this.deselectRow(b), this._selecting = !1, this.grid.getView().focusRow(b)
            }
        },
        rowSelected: function (a, b, c) {
            a = c.getFeature();
            if (!this._selecting && a) {
                for (var b = this.getLayers(), c = 0, d = b.length; c < d; c++)
                    if (-1 == b[c].selectedFeatures.indexOf(a)) {
                        this._selecting = !0;
                        this.selectControl.select(a);
                        this._selecting = !1;
                        this.selectedFeatures.push(a);
                        break
                    }
                this.autoPanMapOnSelection && this.recenterToSelectionExtent()
            }
        },
        rowDeselected: function (a, b, c) {
            a = c.getFeature();
            if (!this._selecting && a) {
                for (var b = this.getLayers(), c = 0, d = b.length; c < d; c++)
                    if (-1 != b[c].selectedFeatures.indexOf(a)) {
                        ...
                        this._selecting = !1;
                        OpenLayers.Util.removeItem(this.selectedFeatures, a);
                        break
                    }
                this.autoPanMapOnSelection && 0 < this.selectedFeatures.length && this.recenterToSelectionExtent()
            }
        },
        getLayers: function () {
...
GeoExt.form.toFilter = function (a, b, c) {
    ...
    return 1 ==
        d.length && b != OpenLayers.Filter.Logical.NOT ? d[0] : new OpenLayers.Filter.Logical({
...
GeoExt.MapPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function () {
        ...
        this.addEvents("aftermapmove", "afterlayervisibilitychange",
            "afterlayeropacitychange", "afterlayerorderchange", "afterlayernamechange", "afterlayeradd", "afterlayerremove");
        this.map.events.on({
    ...
    applyState: function (a) {
        ...
        this.zoom = a.zoom;
        var b,
            c, d, e, f, g = this.map.layers;
        for (b = 0, c = g.length; b < c; b++) d = g[b], e = this.prettyStateKeys ? d.name : d.id, f = a["visibility_" + e], void 0 !== f && (f = /^true$/i.test(f), d.isBaseLayer ? f && this.map.setBaseLayer(d) : d.setVisibility(f)), e = a["opacity_" + e], void 0 !== e && d.setOpacity(e)
    },
    getState: function () {
        var a;
        if (this.map) {
            ...
            for (b = 0, c = f.length; b < c; b++) d = f[b], e = this.prettyStateKeys ? d.name : d.id, a["visibility_" + e] = d.getVisibility(),
    ...
    onBeforeAdd: function (a) {
        "function" ===
            typeof a.addToMapPanel && a.addToMapPanel(this);
...
GeoExt.PrintMapPanel = Ext.extend(GeoExt.MapPanel, {
    ...
    initComponent: function () {
        ...
        this.layers = [];
        Ext.each(this.sourceMap.layers, function (a) {
            if (!0 === a.getVisibility())
                if (a instanceof OpenLayers.Layer.Vector) {
                    for (var b = a.features, c = Array(b.length), a = new OpenLayers.Layer.Vector(a.name), d = 0, e = b.length; d < e; ++d) c[d] =
                        b[d].clone();
                    a.addFeatures(c, {
                        silent: !0
                    });
    ...
    beforeDestroy: function () {
        ...
        this.printProvider.un("layoutchange", this.syncSize,
            this);
...
GeoExt.form.GeocoderComboBox = Ext.extend(Ext.form.ComboBox, {
    ...
    initComponent: function () {
        ...
        if (!this.store) this.store = new Ext.data.JsonStore({
            root: null,
            fields: [{
                name: "name",
    ...
    handleAdded: function () {
        var a = this.findParentBy(function (a) {
            return a instanceof
            GeoExt.MapPanel
        });
        a && this.setMap(a)
    ...
    handleSelect: function (a, b) {
        ...
        if (Ext.isArray(c)) {
            ...
            if (this.layer && c) d = (new OpenLayers.Geometry.Point(c[0],
                c[1])).transform(this.srs, d), this.locationFeature = new OpenLayers.Feature.Vector(d, b.data), this.layer.addFeatures([this.locationFeature])
        }(function () {
            this.triggerBlur();
            this.el.blur()
        }).defer(100, this)
...
GeoExt.form.BasicForm = Ext.extend(Ext.form.BasicForm, {
    ...
    doAction: function (a, b) {
        ...
        }), a = new GeoExt.form.SearchAction(this, b));
        return GeoExt.form.BasicForm.superclass.doAction.call(this, a, b)
    },
    search: function (a) {
...
GeoExt.form.SearchAction = Ext.extend(Ext.form.Action, {
    ...
    constructor: function (a, b) {
        GeoExt.form.SearchAction.superclass.constructor.call(this, a, b)
    },
    run: function () {
        var a = this.options,
            b = GeoExt.form.toFilter(this.form, a.logicalOp, a.wildcard);
        if (!1 === a.clientValidation || this.form.isValid()) a.abortPrevious && this.form.prevResponse && a.protocol.abort(this.form.prevResponse), this.form.prevResponse = a.protocol.read(Ext.applyIf({
            filter: b,
            callback: this.handleResponse,
            scope: this
        }, a));
        else if (!1 !==
            a.clientValidation) this.failureType = Ext.form.Action.CLIENT_INVALID, this.form.afterAction(this, !1)
    },
    handleResponse: function (a) {
        this.form.prevResponse = null;
        this.response = a;
        a.success() ? this.form.afterAction(this, !0) : this.form.afterAction(this, !1);
        var b = this.options;
        b.callback && b.callback.call(b.scope, a)
    }
});
Ext.namespace("GeoExt.form");
...
GeoExt.UrlLegend.supports = function (a) {
    return null == a.get("legendURL") ? 0 : 10
};
...
GeoExt.ZoomSlider = Ext.extend(Ext.slider.SingleSlider, {
    ...
    initZoomValues: function () {
        ...
        if (void 0 === this.initialConfig.minValue) this.minValue = a.minZoomLevel ||
            0;
    ...
    update: function () {
        if (this.rendered && this.map) this.updating = !0, this.setValue(this.map.getZoom()), this.updating = !1
    }
});
...
GeoExt.FeatureRenderer = Ext.extend(Ext.BoxComponent, {
    ...
    initComponent: function () {
        ...
        Ext.applyIf(this, {
            pointFeature: new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(0,
                0)),
            ...
            polygonFeature: new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing([new OpenLayers.Geometry.Point(-8, -4), new OpenLayers.Geometry.Point(-6, -6), new OpenLayers.Geometry.Point(6, -6), new OpenLayers.Geometry.Point(8, -4), new OpenLayers.Geometry.Point(8,
    ...
    setRendererDimensions: function () {
        ...
        this.renderer.setSize(new OpenLayers.Size(Math.round(b),
            Math.round(c)));
    ...
    drawFeature: function () {
        this.renderer.clear();
        this.setRendererDimensions();
        for (var a, b, c = 0, d = this.symbolizers.length; c < d; ++c) {
...
GeoExt.WMSLegend = Ext.extend(GeoExt.LayerLegend, {
    ...
    onLayerMoveend: function (a) {
        if (!0 === a.zoomChanged && !0 === this.useScaleParameter || this._noMap) delete this._noMap, this.update()
    },
    ...
    update: function () {
        ...
        if (a && a.map) {
            ...
            for (d = 0, a = b.length; d < a; d++) c = b[d], (!this.items || !this.getComponent(c)) && this.add({
...
GeoExt.tree.LayerContainer = Ext.extend(Ext.tree.AsyncTreeNode, {
    ...
    recordIndexToNodeIndex: function (a) {
        for (var b = this.loader.store, c = this.childNodes.length, d = -1, e = b.getCount() - 1; 0 <= e && !(!0 === this.loader.filter(b.getAt(e)) && (++d,
            a === e || d > c - 1)); --e);
        return d
    },
    destroy: function () {
...
GeoExt.tree.LayerParamNode = Ext.extend(Ext.tree.TreeNode, {
    ...
    constructor: function (a) {
        ...
        if (this.layer) {
            ...
            if (null == this.attributes.checked) this.attributes.checked =
                this.layer.getVisibility() && 0 <= this.getItemsFromLayer().indexOf(this.item);
    ...
    onLayerVisibilityChanged: function () {
        ...
        a && -1 !== this.getItemsFromLayer().indexOf(this.item) &&
            this.getUI().toggleCheck(!0);
        a || (this.layer.mergeNewParams(this.createParams([])), this.getUI().toggleCheck(!1))
    },
    onCheckChange: function (a, b) {
        var c = this.layer,
            d = [],
            e = this.getItemsFromLayer();
        !0 === b && !1 === c.getVisibility() && e.length === this.allItems.length && (e = []);
        Ext.each(this.allItems, function (a) {
            (a !== this.item && -1 !== e.indexOf(a) || !0 === b && a === this.item) && d.push(a)
        }, this);
        var f = 0 < d.length;
        f && c.mergeNewParams(this.createParams(d));
        f !== c.getVisibility() && c.setVisibility(f);
...
GeoExt.tree.LayerNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    render: function (a) {
        ...
        //Adding checkbox exception parameter. @nachoalthabe
        if (void 0 === b.checked && !b.noCheckbox) b.checked = this.node.layer.getVisibility();
        ...
        var c = this.checkbox;
        if (b.checkedGroup) b = Ext.DomHelper.insertAfter(c, ['<input type="radio" name="', b.checkedGroup, '_checkbox" class="', c.className, c.checked ? '" checked="checked"' : "", '"></input>'].join("")), b.defaultChecked = c.defaultChecked, Ext.get(c).remove(), this.checkbox = b;
    ...
    toggleCheck: function (a) {
        ...
        GeoExt.tree.LayerNodeUI.superclass.toggleCheck.call(this,
            a);
        this.enforceOneVisible()
    },
    enforceOneVisible: function () {
        ...
        if (b && "gx_baselayer" !== b) {
            ...
            Ext.each(d, function (d) {
                var g = d.layer;
                !d.hidden && d.attributes.checkedGroup === b && (e++, g != c && a.checked && g.setVisibility(!1))
            });
...
GeoExt.tree.LayerNode = Ext.extend(Ext.tree.AsyncTreeNode, {
    ...
    constructor: function (a) {
        ...
        GeoExt.tree.LayerNode.superclass.constructor.apply(this,
            arguments)
    },
    render: function (a) {
        ...
        if (!this.rendered || !b) {
            ...
            if (b) {
                this.layer = b;
                if (b.isBaseLayer) this.draggable = !1, Ext.applyIf(this.attributes, {
                    checkedGroup: "gx_baselayer"
                });
                this.autoDisable = !(!1 === this.autoDisable ||
                    this.layer.isBaseLayer || this.layer.alwaysInRange);
    ...
    addVisibilityEventHandlers: function () {
        ...
        this.autoDisable && (this.layer.map ? this.layer.map.events.register("moveend",
            this, this.onMapMoveend) : this.layer.events.register("added", this, function b() {
    ...
    onStoreAdd: function (a, b) {
        for (var c, d = 0; d < b.length; ++d)
            if (c = b[d].getLayer(), this.layer == c) {
                this.getUI().show();
                break
    ...
    onStoreUpdate: function (a,
        b) {
        var c = b.getLayer();
        !this.fixedText && this.layer == c && this.text !== c.name && this.setText(c.name)
    },
    destroy: function () {
        var a = this.layer;
        ...
        delete this.layer;
        if (a = this.layerStore) a.un("add", this.onStoreAdd, this), a.un("remove", this.onStoreRemove, this), a.un("update", this.onStoreUpdate, this);
        delete this.layerStore;
        this.un("checkchange", this.onCheckChange,
            this);
...
GeoExt.tree.TreeNodeUIEventMixin = function () {
    return {
        ...
        onClick: function (a) {
            !1 !== this.fireEvent("rawclicknode", this.node, a) && this.superclass.onClick.apply(this, arguments)
        }
    }
};
Ext.namespace("GeoExt.tree");
...
Ext.extend(GeoExt.tree.LayerLoader, Ext.util.Observable, {
    ...
    addLayerNode: function (a, b, c) {
        c = c || 0;
        !0 === this.filter(b) && (b = this.createNode({
            nodeType: "gx_layer",
            layer: b.getLayer(),
    ...
    onChildMove: function (a, b, c, d, e) {
        ...
        if (d instanceof GeoExt.tree.LayerContainer && this.store === d.loader.store) {
            ...
            if (1 < d.childNodes.length) {
                ...
                var h = d;
                do h = h.previousSibling; while (h && !(h instanceof GeoExt.tree.LayerContainer && h.lastChild));
                if (h) f = this.store.findBy(function (a) {
                    return h.lastChild.layer === a.getLayer()
                });
                else {
                    var i = d;
                    do i = i.nextSibling; while (i && !(i instanceof GeoExt.tree.LayerContainer && i.firstChild));
...
Ext.extend(GeoExt.tree.LayerParamLoader, Ext.util.Observable, {
    ...
    load: function (a, b) {
        if (this.fireEvent("beforeload", this, a)) {
            ...
            c && (c = c instanceof Array ? c.slice() : c.split(this.delimiter), Ext.each(c, function (b, c, f) {
...
Ext.extend(GeoExt.tree.WMSCapabilitiesLoader, Ext.tree.TreeLoader, {
    ...
    processResponse: function (a, b, c, d) {
        a = (new OpenLayers.Format.WMSCapabilities).read(a.responseXML && a.responseXML.documentElement ? a.responseXML : a.responseText);
        a.capability && this.processLayer(a.capability, a.capability.request.getmap.href, b);
        "function" == typeof c && c.apply(d || b, [b])
    },
    createWMSLayer: function (a,
        b) {
        return a.name ? new OpenLayers.Layer.WMS(a.title, b, OpenLayers.Util.extend({
            format: a.formats[0],
            layers: a.name
    ...
    processLayer: function (a, b, c) {
        Ext.each(a.nestedLayers, function (a) {
                var e = this.createNode({
                    text: a.title || a.name,
                    nodeType: "node",
                    layer: this.createWMSLayer(a, b),
                    leaf: 0 === a.nestedLayers.length
                });
                e && c.appendChild(e);
                a.nestedLayers && this.processLayer(a, b, e)
            },
            this)
    }
});
...
GeoExt.LegendPanel = Ext.extend(Ext.Panel, {
    ...
    recordIndexToPanelIndex: function (a) {
        for (var b = this.layerStore,
            c = -1, d = this.items ? this.items.length : 0, e, f, g = b.getCount() - 1; 0 <= g && !(e = b.getAt(g), f = e.getLayer(), e = GeoExt.LayerLegend.getTypes(e), f.displayInLayerSwitcher && 0 < e.length && !0 !== b.getAt(g).get("hideInLegend") && (++c, a === g || c > d - 1)); --g);
        return c
    },
    ...
    removeLegend: function (a) {
        if (this.items &&
            (a = this.getComponent(this.getIdForLayer(a.getLayer())))) this.remove(a, !0), this.doLayout()
    },
    ...
    addLegend: function (a, b) {
        if (!0 === this.filter(a)) {
            ...
            c.displayInLayerSwitcher && !a.get("hideInLegend") && 0 < d.length && this.insert(b, {
                ...
                layerRecord: a,
                hidden: !(!c.map && c.visibility || c.getVisibility() &&
                    c.calculateInRange())
            })
        }
    },
...
GeoExt.state.PermalinkProvider = function (a) {
...
GeoExt.Lang = new(Ext.extend(Ext.util.Observable, {
    ...
    set: function (a) {
        for (var b = a ? a.split("-") : [], c = "", d = {}, e, f = 0, g = b.length; f <
            g; ++f)
            if (c += (c && "-" || "") + b[f], c in this.dict) {
                e = this.dict[c];
                for (var h in e) h in d ? Ext.apply(d[h], e[h]) : d[h] = Ext.apply({}, e[h])
            }
        for (h in d) {
            b = window;
            c = h.split(".");
...
(function () {
    var a = function (a, c) {
        return function (d) {
            c && c[a] && c[a].call(c.scope || window, Ext.applyIf({
                argument: c.argument
            }, d))
        }
    };
    Ext.apply(Ext.lib.Ajax, {
        request: function (b, c, d, e, f) {
            var f = f || {},
                b = b || f.method,
                g = f.headers;
            if (f.xmlData) {
                if (!g || !g["Content-Type"]) g = g || {}, g["Content-Type"] = "text/xml";
                b = b || "POST";
                e = f.xmlData
            } else if (f.jsonData) {
                if (!g || !g["Content-Type"]) g = g || {}, g["Content-Type"] = "application/json";
                b = b || "POST";
                e = "object" == typeof f.jsonData ? Ext.encode(f.jsonData) : f.jsonData
            }
            if (b && "post" == b.toLowerCase() &&
                (f.form || f.params) && (!g || !g["Content-Type"])) g = g || {}, g["Content-Type"] = "application/x-www-form-urlencoded";
